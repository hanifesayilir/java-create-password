...
public class Message {
    ...
    static final String WELLCOME_TITLE = "Wellcome to the BESTPASSWORDCREATER";
    ...
    static final String ASK_FOR_ANY_VALID_INPUT = "Please enter a valid input. One of the following characters 'Y', 'y', 'n', 'N' are considered valid only.";
}
